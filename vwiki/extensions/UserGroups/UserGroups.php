...
$wgGroupPermissions['sysop']['editmywatchlist'] = true;
$wgGroupPermissions['sysop']['modifygroups'] = true;
$wgGroupPermissions['sysop']['read'] = true;
$wgGroupPermissions['sysop']['renameuser'] = true;
$wgGroupPermissions['sysop']['sendemail'] = true;
$wgGroupPermissions['sysop']['userrights'] = true;
$wgGroupPermissions['sysop']['viewmywatchlist'] = true;
unset( $wgAddGroups['Admiral'] );
unset( $wgGroupPermissions['Admiral'] );
unset( $wgGroupsAddToSelf['Admiral'] );
unset( $wgGroupsRemoveFromSelf['Admiral'] );
unset( $wgRemoveGroups['Admiral'] );
unset( $wgRevokePermissions['Admiral'] );
