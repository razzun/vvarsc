		...
		<div class="unit_details_container">
			...
			<div class="shipDetails_info1_table_ship_desc" style="font-style: normal">
				...
				<div class="WikiText">
					...
					<br />
					<br />
					Each Squadron or Platoon will sortie one or more <strong>Flights</strong> or <strong>Teams</strong> for organized operations. These Flights/Teams are led by NCOs, but are not considered Permanent Units within the Fleet. For air units, a Flight normally consists of at least 2 ships, and the number of ships per Flight will vary based on the type of equipment operated by each Squadron during a particular operation. In some cases, especially with larger multi-crew ships, a single vessel may comprise the entire Flight. For ground units, a Team consists of no-more than 6 members (including the Team Leader).
					<br />
					<br />
				...
				<h5 class="WikiH5">Air-Wing/Company</h5>
				<div class="WikiText">
					Moving up the hierarchy tree, we find the <strong>Air Wing</strong> and <strong>Company</strong>-level units. These units will only be established once there are at-minimum 3 Squadrons/Platoons existing below them, and there is a need for a parent-unit to be created for oversight in planning and operational execution. Due to constraints inherent to the numbering system described below, a single Air Wing can contain a maximum of 9 Squadrons. The Air Wing and Company units will be commanded by an Officer of at-least O-3 PayGrade. Their command staff may also include additional Officers, and Senior NCOs serving as advisers.
				</div>
				<h5 class="WikiH5">Combat Group/Battalion</h5>
				<div class="WikiText">
				...
				<div class="WikiText">
					Larger-size units such as Combat Groups/Battalions and Air Wings/Companies are numbered in the order they are created - meaning that the first Combat Group created within the Military Division will be numbered and named "1st Combat Group", same for the "1st Marine Battalion".
					<br />
					<br />
					...
					<br />
					<br />
					For Marine Companies, these are named by Phonetic letter in alphabetical order ("Alpha Company", "Bravo Company", etc), where names will be reused within each Battalion.
					<br />
					<br />
					...
					<br />
					<br />
					For Marine Platoons, these are numbered in-order of creation within a Company ("1st Platoon", "2nd Platoon", etc), where names will be reused within each Company.
				</div>
			</div>
		</div>
	</div>
